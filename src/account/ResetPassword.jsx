// Form for requesting a password reset which is displayed when the route
// receives a valid reset token in the url parameters.
// The token is validated by accountService.validateResetToken(token) from a useEffect hook
// Token status controls what is displayed to the UI, either validating, valid, or invalid.
// On submit, accountService.resetPassword(token, password) handles the reseting of the password.
